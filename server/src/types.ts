...
export interface Expedition {
  id: string;
  expeditionCode: string; // e.g. ISEA-44
  title: string;
  theme: string;
...
export interface InventoryItem {
  ...
  storageLocation: string; // e.g. "Main Hangar - Bay B", "Cryo Bay 4", "East Fuel Farm"
  expiryDate?: string;
...
export interface Personnel {
  ...
  stationId: string;
  organization: string; // e.g. NCPOR, IMD, Geological Survey of India, Indian Navy, AIIMS
  bloodGroup: string;
