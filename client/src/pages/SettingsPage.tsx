...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel p-4 rounded-2xl border border-cyan-900/60 space-y-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-xs pt-1">
          <div className="p-2.5 rounded-xl bg-polar-900 border border-slate-800 flex items-center justify-between">
            <div>
              <div className="text-slate-400 text-[10px] font-mono">FASTAPI CORE</div>
              <div className="text-emerald-400 font-bold font-mono">🟢 ONLINE</div>
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-polar-900 border border-slate-800 flex items-center justify-between">
            <div>
              <div className="text-slate-400 text-[10px] font-mono">DB / POSTGIS</div>
              <div className="text-emerald-400 font-bold font-mono">🟢 READY</div>
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-polar-900 border border-slate-800 flex items-center justify-between">
            <div>
              <div className="text-slate-400 text-[10px] font-mono">OSM GIS TILES</div>
              <div className="text-emerald-400 font-bold font-mono">🟢 ACTIVE</div>
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-polar-900 border border-slate-800 flex items-center justify-between">
            <div>
              <div className="text-slate-400 text-[10px] font-mono">SAT-LINK SYNC</div>
              <div className="text-emerald-400 font-bold font-mono">🟢 ACTIVE</div>
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-polar-900 border border-slate-800 flex items-center justify-between">
            <div>
              <div className="text-slate-400 text-[10px] font-mono">EVENT ENGINE</div>
              <div className="text-emerald-400 font-bold font-mono">🟢 RUNNING</div>
            </div>
      ...
      <div className="glass-panel p-5 rounded-2xl space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-rose-950/80 hover:bg-rose-900 border border-rose-600 text-rose-300 font-mono text-xs transition"
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-white font-mono font-bold text-xs flex items-center space-x-1.5 transition"
            >
        ...
        <div className={`p-4 rounded-xl border flex flex-wrap items-center justify-between gap-3 ${
          ...
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg font-bold font-mono text-xs ${chainVerified ? 'bg-emerald-600 text-white' : 'bg-rose-600 text-white'}`}>
        ...
        <div className="p-3.5 rounded-xl bg-polar-900 border border-slate-800 space-y-2 text-xs font-mono">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-[10px]">
            <div className="p-2 rounded bg-polar-950 border border-slate-800 overflow-hidden">
              <span className="text-slate-500 block mb-0.5">PREVIOUS HASH:</span>
              <code className="text-slate-300 break-all">e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855</code>
            </div>
            <div className="p-2 rounded bg-polar-950 border border-slate-800 overflow-hidden">
              <span className="text-slate-500 block mb-0.5">TRANSACTION DATA:</span>
              <code className="text-cyan-300 break-all">{`{"action":"CUSTODY_HANDOVER","cargo":"CRG-BIO-089","tempC":-64.2}`}</code>
            </div>
            <div className="p-2 rounded bg-polar-950 border border-slate-800 overflow-hidden">
              <span className="text-slate-500 block mb-0.5">CURRENT BLOCK HASH:</span>
              <code className="text-emerald-400 break-all">8f4e2b819e918bc27c62b404d5b225916a048a1c93a02796e987c6742a98129f</code>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel p-5 rounded-2xl space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs font-mono divide-y divide-slate-800 border border-slate-800 rounded-xl overflow-hidden">
            <thead className="bg-polar-900 text-slate-300 text-[11px]">
              <tr>
                <th className="py-2.5 px-3">Operational Capability</th>
                <th className="py-2.5 px-2 text-center text-cyan-300">Admin</th>
                <th className="py-2.5 px-2 text-center text-indigo-300">Expedition</th>
                <th className="py-2.5 px-2 text-center text-amber-300">Logistics</th>
                <th className="py-2.5 px-2 text-center text-emerald-300">Station</th>
                <th className="py-2.5 px-2 text-center text-rose-300">Emergency</th>
                <th className="py-2.5 px-2 text-center text-slate-400">Viewer</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-800/60 bg-polar-950/60 text-[11px]">
              {PERMISSION_MATRIX.map((row, idx) => (
                <tr key={idx} className="hover:bg-polar-900/40 transition">
                  <td className="py-2 px-3 font-medium text-slate-200">{row.action}</td>
                  <td className="py-2 px-2 text-center">{row.admin ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                  <td className="py-2 px-2 text-center">{row.expedition ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                  <td className="py-2 px-2 text-center">{row.logistics ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                  <td className="py-2 px-2 text-center">{row.station ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                  <td className="py-2 px-2 text-center">{row.emergency ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                  <td className="py-2 px-2 text-center">{row.viewer ? <span className="text-emerald-400 font-bold">✓</span> : <span className="text-slate-600">—</span>}</td>
                </tr>
              ))}
            </tbody>
          </table>
