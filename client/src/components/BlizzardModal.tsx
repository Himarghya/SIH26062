...
export const BlizzardModal: React.FC<BlizzardModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-fadeIn">
      <div className="relative w-full max-w-xl bg-white border border-rose-200 rounded-3xl overflow-hidden shadow-2xl">
        {/* Header */}
        <div className="bg-rose-50 px-6 py-4 flex items-center justify-between border-b border-rose-200">
